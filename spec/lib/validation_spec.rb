...
RSpec.describe Validation do
  describe "#validate_name" do
    ...
    describe "#validate_network_volume_config" do
      ...
      it "applies the ratio to the baseline IOPS when none was requested" do
        # provisioning would send the 3000 IOPS baseline, which tops out at 750
      ...
      it "bounds hyperdisk throughput on both sides by IOPS" do
        # MIN(2400, P/4): 3000 IOPS allows at most 750
        ...
        # MAX(140, P/256): 160,000 IOPS requires at least 625
      ...
      it "applies the baseline throughput when none was requested" do
        # provisioning would send 140 MiB/s, below the 625 that 160,000 IOPS needs
  ...
  describe "#validate_provider_location_name" do
