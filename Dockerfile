FROM docker.io/library/node:24.12-alpine3.23 AS frontend-builder
WORKDIR /app
...
FROM docker.io/library/ruby:3.4.8-alpine3.23 AS bundler
...
FROM docker.io/library/ruby:3.4.8-alpine3.23
